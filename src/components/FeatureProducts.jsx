...
const FeatureProducts = () => {
  ...
  return (
    <section className='lg:container lg:mx-auto py-8 px-4'>
        ...
        <div className='row grid lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-4'>
            {
        ...
        <div className='row grid lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-4 mt-4'>
            {
